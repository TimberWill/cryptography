...
public class Test7 {
    ...
    final static String[] attributeList = {"ECNU","post_graduate","information_security","doctor","FuDan","SJTU"};//用户属性域
    ...
    final static String accessPolicy = "(ECNU or FuDan or SJTU) and (post_graduate or doctor) and information_security";//访问策略表达式
