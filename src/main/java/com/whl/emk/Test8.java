...
public class Test8 {
    ...
    final static String[] attributeList = {"ECNU","post_graduate","information_security","doctor","FuDan","SJTU","TongJi","AI"};//用户属性域
    final static String[] w = {"sex","height","weight","major","school","location"};//大关键字集合
    final static String[] w0 = {"sex","height","weight","major","school","location"};//用户搜索关键字集合
    final static String accessPolicy = "(ECNU or FuDan or SJTU or TongJi) and (post_graduate or doctor) and (information_security or AI)";//访问策略表达式
