 ...
 */
public class MyCode {
    final static String[] userList = {"ECNU","post_graduate","information_security","doctor","AI"};//大属性域

    final static String[] attributeList = {"ECNU","post_graduate","information_security"};//用户属性域
    final static String accessPolicy = "ECNU and post_graduate";//访问策略表达式

    final static String[] keywordValue_u = {"female","162","55"};//大关键字值域

    final static String keyword_accessPolicy = "sex and height and weight";//访问策略表达式
    final static String[] keywordList = {"sex","height","weight"};//用户关键字集
    final static String[] keywordValue_s = {"female","162","55"};//用户关键字域
