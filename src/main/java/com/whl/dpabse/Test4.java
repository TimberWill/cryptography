...
public class Test4 {
    ...
    final static String[] attributeList = {"ECNU","post_graduate","information_security","doctor","FuDan","TongJi","AI","FL"};//用户属性域
    final static String accessPolicy = "(ECNU or FuDan or TongJi) and (post_graduate or doctor) and (information_security or AI or FL)";//访问策略表达式
